...
async function loadLanguage(language) {
    try {
        ...
        document.getElementById('projectTitleTwo').textContent = data.projectTitle;
        document.getElementById('projectDesTwo').textContent = data.projectDesc;
        document.getElementById('projectTitleThree').textContent = data.projectTitle;
        document.getElementById('projectDesThree').textContent = data.projectDesc;
